      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url().'userimg/'.$this->session->userdata('image');?>" class="user-image" alt="User Image">
...
<!--                 <div class="row">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  ...
                  <a href="<?php echo base_url().'/index.php/admin/home/index'?>" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
